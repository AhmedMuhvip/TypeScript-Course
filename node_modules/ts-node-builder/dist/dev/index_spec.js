...
describe('Command Runner Builder', () => {
    ...
    it('The dev server starts successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const run = yield architect.scheduleBuilder('ts-node-builder:dev', options, { logger }); // We pass the logger for checking later.
